...
namespace WebStore.Infrastructure.Services.InMemory
{
    public class InMemoryEmployeesData : IEmployeesData
    {
        ...
        public void Update(Employee employee)
        {
            ...
            db_item.Id = employee.Id;
            db_item.Age = employee.Age;
            db_item.DateOfHiring = employee.DateOfHiring;
            db_item.Education = employee.Education;
            db_item.Experience = employee.Experience;
            db_item.FirstName = employee.FirstName;
            db_item.IQ = employee.IQ;
            db_item.LastName = employee.LastName;
            db_item.Patronymic = employee.Patronymic;
            db_item.PhoneNumber = employee.PhoneNumber;            
